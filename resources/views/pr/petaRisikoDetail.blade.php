                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        @if (Auth::user()->id_level == 1 ||
                                                                            ...
                                                                            Auth::user()->id_level == 4 ||
                                                                            Auth::user()->id_level == 6)
                                                                            <form action="{{ route('petas.approve', ['id' => $firstDocument->id]) }}" method="POST">
                                                                                @csrf
                                                                                <button type="submit" class="btn btn-success">Approve</button>
                                                                            </form>
                                                                            @if ($document['approval'] == 'approved')
                                                                                <p>{{ \Carbon\Carbon::parse($document['approval_at'])->format('d F Y') }}</p>
                                                                            @endif
                                                                        @endif
                                                                    </td>
                                                                    <td>
                                                                        @if (Auth::user()->id_level == 1 ||
                                                                            ...
                                                                            Auth::user()->id_level == 4 ||
                                                                            Auth::user()->id_level == 6)
                                                                            <form action="{{ route('petas.disapprove', ['id' => $firstDocument->id]) }}" method="POST" style="display:inline;">
                                                                                @csrf
                                    ...
                                    @if (Auth::user()->id_level == 1 || Auth::user()->id_level == 5)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('updateDataByJenis', $item->jenis) }}" method="POST" enctype="multipart/form-data">
                                                    @csrf

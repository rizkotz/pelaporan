@extends('layout.main')
@section('title','Tambah Auditee')

@section('isi')

<div class="col-md-10 p-5 pt-2">
    <h3><i class="fa fa-angle-double-right"></i>Tambah Auditee</h3><hr>
    <h4 class="tittle-1">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card border-0 shadow rounded">
                <div class="card-body">
                    <form action="{{ route('audites.store') }}" method="POST" enctype="multipart/form-data">

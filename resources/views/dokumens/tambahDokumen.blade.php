...
<div class="col-md-16 p-4 pt-2">
    <h3><i class="fa fa-angle-double-right"></i>Tambah Dokumen</h3><hr>
    <h4 class="tittle-1">
                ...
                <div class="card-body">
                    <form action="{{ route('dokumens.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('judul') is-invalid @enderror" name="judul" value="{{ old('judul') }}" placeholder="Masukkan Judul Dokumen...">

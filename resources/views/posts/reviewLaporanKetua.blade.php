...
<div class="col-md-16 p-5 pt-2">
    <h3><i class="fa-solid fa-list-check mr-2"></i>PIC Kegiatan Ketua</h3><hr>
    <h4 class="tittle-1">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <form action="/reviewLaporanKetua/searchKetua"  method="GET">
                                ...
                                <input type="search" name="search" class="form-control float-right" placeholder="Search: Masukkan Tahun/ Judul">
